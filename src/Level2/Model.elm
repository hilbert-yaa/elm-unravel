...
settings =
    let 
        lamps = [ lamp (Point3d.meters 12 12 0) 225, lamp (Point3d.meters 12 -12 0) 135, lamp (Point3d.meters -12 12 0) 315
...
init =
    ...
    let
        ...
        initGoal = Point3d.meters -1 1 100
        groundSize = GroundSize 20 20 --地面边界
        mapSize = GroundSize 5 5 --地图边界（空气墙）
    ...
    , Cmd.batch [ playSound "reverse_long"
        , Task.perform
            (\{ viewport } ->
                Resize
