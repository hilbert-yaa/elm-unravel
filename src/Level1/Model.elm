...
actives =
    let
        ...
        blocksUp = List.map (\center -> buildColorBlock center (Color.rgb255 187 231 231) Nothing Up) [p10,p12,p14]
...
settings =
    let 
        ...
        tallWall = Scene3d.blockWithShadow (Material.color Color.black) (Block3d.from (Point3d.meters -44 -20 0) (Point3d.meters -8 -19 8))
        -- shade = [
    ...
    in
    Scene3d.group
        <| store++lamps++[text1, tallWall]--++shade
...
boundary =
    let
        ...
        l11 = buildLine "hor" 3 3 35
        l12 = buildLine "hor" 3 -7 35
...
init =
    -- 方块的边长是2
    let
        initCenter = Point3d.meters -19 -29 1 --self初始位置 -19 -29 1
