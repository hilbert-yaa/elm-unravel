...
actives =
    let
        p1 = Point3d.meters -3 -15 1
        p2 = Point3d.meters 5 -9 1

        p3 = Point3d.meters -5 -1 1
        p4 = Point3d.meters -3 1 1
        p5 = Point3d.meters 1 -3 1
        p6 = Point3d.meters -3 -5 1
        p7 = Point3d.meters 1 11 1
        p8 = Point3d.meters -3 31 1
        p9 = Point3d.meters -3 13 1
        p10 = Point3d.meters 3 13 1
        p11 = Point3d.meters 3 1 1
        p12 = Point3d.meters 1 7 1
        p13 = Point3d.meters 7 15 1
        p14 = Point3d.meters 1 25 1
        p15 = Point3d.meters 3 33 1
        blocksG = List.map (\center -> buildColorBlock center (Color.rgb255 172 215 216) Nothing G) [p1,p2,p3,p4,p15]
        blocksClock = List.map (\center -> buildColorBlock center (Color.rgb255 172 215 216) Nothing Clock) [p5,p6,p7]
        blocksLeft = List.map (\center -> buildColorBlock center (Color.rgb255 139 198 198) Nothing Left) [p8,p9,p13]
        blocksUp = List.map (\center -> buildColorBlock center (Color.rgb255 187 231 231) Nothing Up) [p10,p11,p12,p14]
        blocks = blocksG ++ blocksLeft ++ blocksClock ++ blocksUp
    in
        blocks
...
settings =
    let 
        ...
        road1 = Scene3d.block (Material.color Color.white) (Block3d.from (Point3d.meters -4 initY -0.1) (Point3d.meters 2 -141 -100))
        road2 = Scene3d.block (Material.matte (Color.rgb255 66 66 66 )) (Block3d.from (Point3d.meters -4 initY 0) (Point3d.meters 2 -141 -0.1))
        -- shade = [
...
boundary =
    let
        ...
        l9 = buildLine "ver" 4 9 17
        l10 = buildLine "ver" 1 9 33
...
init =
    -- 方块的边长是2
    let
        initCenter = Point3d.meters -1 (initY + 20) 1 --self初始位置 (initY + 20)
        initBlock = buildBlock initCenter
        initGoal = Point3d.meters 1 33 1
        groundSize = GroundSize 57 55 --地面边界
        mapSize = GroundSize 20 15 --地图边界（空气墙）
        initWall = boundary
        initScene =
...
buildStore center = 
    let
        ...
        y  = center.y
        z  = center.z
        block1 = Block3d.from (Point3d.meters (x-10) (y-6) (z+7)) (Point3d.meters (x+10) (y+6) (z+8))
        block2 = Block3d.from (Point3d.meters (x-10) (y-6) z) (Point3d.meters (x-2) (y-4) (z+8))
        block3 = Block3d.from (Point3d.meters (x+10) (y-6) z) (Point3d.meters (x+2) (y-4) (z+8))
        block4 = Block3d.from (Point3d.meters (x-2) (y-6) (z+4)) (Point3d.meters (x+2) (y-4) (z+8))
        block5 = Block3d.from (Point3d.meters (x-10) (y+6) z) (Point3d.meters (x+10) (y+8) (z+8))
        block6 = Block3d.from (Point3d.meters (x-10) (y-6) z) (Point3d.meters (x-8) (y+6) (z+8))
        block7 = Block3d.from (Point3d.meters (x+8) (y-6) z) (Point3d.meters (x+10) (y+8) (z+8))
    in
        let
            blocks = List.map (\block -> Scene3d.blockWithShadow (Material.matte Color.gray) block) [block1, block2, block3, block4, block5, block6, block7]
        in
