...
actives =
    let
        ...
        p2 = Point3d.meters -5 -13 1
        p3 = Point3d.meters 3 -19 1
        p4 = Point3d.meters -5 13 1
        p5 = Point3d.meters -3 13 1
        p6 = Point3d.meters -1 13 1
        p7 = Point3d.meters -5 -5 1
        p8 = Point3d.meters 3 -7 1
        p9 = Point3d.meters -3 -13 1
        p10 = Point3d.meters 5 1 1
        p11 = Point3d.meters 3 1 1
        p12 = Point3d.meters -5 7 1
        p13 = Point3d.meters 5 19 1
...
settings = 
    let 
        lamps = [ lamp (Point3d.meters 6 7 0) 90, lamp (Point3d.meters 6 -7 0) -90, lamp (Point3d.meters -6 7 0) 90
                , lamp (Point3d.meters -6 -7 0) -90, lamp (Point3d.meters 6 17 0) -90, lamp (Point3d.meters 6 -17 0) 90
                , lamp (Point3d.meters -6 17 0) -90, lamp (Point3d.meters -6 -17 0) 90]
        roads = [ road (Point3d.meters 10 7.6 0) (Point3d.meters -10 10.4 0.01) (Color.rgb255 30 30 30) 
