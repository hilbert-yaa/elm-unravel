...
maze =
    let
        l1 =
            buildBrick "ver" 13 -1 3

        l2 =
            buildBrick "hor" 17 -1 27

        l3 =
            buildBrick "hor" 6 17 23

        l4 =
            buildBrick "hor" 5 23 19

        l5 =
            buildBrick "hor" 5 23 13

        l6 =
            buildBrick "hor" 10 13 7

        l7 =
            buildBrick "hor" 14 5 3

        l8 =
            buildBrick "hor" 7 5 13

        l9 =
            buildBrick "hor" 2 15 17

        l10 =
            buildBrick "hor" 3 1 17

        l11 =
            buildBrick "hor" 2 3 21

        l12 =
            buildBrick "hor" 2 3 23

        l13 =
            buildBrick "hor" 1 23 21

        l14 =
            buildBrick "ver" 6 5 3

        l15 =
            buildBrick "ver" 5 13 13

        l16 =
            buildBrick "hor" 3 -1 1
    in
...
buildLine dir num x y =
    let
        blocks =
            case dir of
                "hor" ->
                    List.map (\point -> Point3d.meters (toFloat (x + 2 * point - 2)) (toFloat y) 1) (List.range 1 num)

                "ver" ->
                    List.map (\point -> Point3d.meters (toFloat x) (toFloat (y + 2 * point - 2)) 1) (List.range 1 num)
...
buildBrick dir num x y =
    let
        ...
        --quantity 写起来手感不好，如果之后出问题了我立马改呜呜呜呜
        vec =
            case dir of
                "hor" ->
                    Vector3d.fromMeters
        ...
        center =
            Point3d.meters (toFloat center_x) (toFloat center_y) 1
...
initWall_4 =
    let
        l17 =
            buildLine "hor" 14 33 -1

        l18 =
            buildLine "hor" 14 33 7

        l19 =
            buildLine "ver" 5 61 -1

        l20 =
            buildLine "ver" 1 31 1

        l1 =
            buildLine "ver" 13 -1 3

        l2 =
            buildLine "hor" 17 -1 27

        l3 =
            buildLine "hor" 6 17 23

        l4 =
            buildLine "hor" 5 23 19

        l5 =
            buildLine "hor" 5 23 13

        l6 =
            buildLine "hor" 10 13 7

        l7 =
            buildLine "hor" 14 5 3

        l8 =
            buildLine "hor" 7 5 13

        l9 =
            buildLine "hor" 2 15 17

        l10 =
            buildLine "hor" 3 1 17

        l11 =
            buildLine "hor" 2 3 21

        l12 =
            buildLine "hor" 2 3 23

        l13 =
            buildLine "hor" 1 23 21

        l14 =
            buildLine "ver" 6 5 3

        l15 =
            buildLine "ver" 5 13 13
...
settings =
    let
        lamp_ =
            [ lamp (Point3d.meters 63 5 0) 180 ]

        boy =
            [ Scene3d.blockWithShadow (Material.color Color.white) (buildBlock (Point3d.meters 61 5 1)) ]
    in
    Scene3d.group <|
        lamp_
            ++ boy
